...
//		oks.setCustomerLogo(logo, label, listener);
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btnShareAllGui) {
            // photo-text sharing
            showShare(false, null);
        } else if (id == R.id.btnShareAll) {
            // share directly
            showShare(true, null);
        } else if (id == R.id.btnFlSw) {
