...
public class CustomerPage extends SlidingMenuPage implements
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btnDb) {
            ...
            facebookEvent();
        } else if (id == R.id.btnNemb) {
            neteaseMb();
        } else if (id == R.id.btnRr) {
            renren();
        } else if (id == R.id.btnSw) {
            sinaWeibo();
        } else if (id == R.id.btnQz) {
            qzone();
        } else if (id == R.id.btnTc) {
            tencentWeibo();
        } else if (id == R.id.btnTw) {
            twitter();
        } else if (id == R.id.btnKx) {
            kaixin();
        } else if (id == R.id.btnShmb) {
            sohuMb();
        } else if (id == R.id.btnYd) {
            youdaoNote();
        } else if (id == R.id.btnShSSK) {
            SohuSuishenkan();
        }
    }
